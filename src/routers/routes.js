...
import PrivacyTerms from "../themes/privacy-terms";
      ...
      <div>
        <Router>
          ...
          <Switch>
            ...
            <Route exact path="/item-details/:idx" component={ItemDetails} />
            <Route exact path="/activity" component={Activity} />
            <Route exact path="/blog" component={Blog} />
            <Route exact path="/blog-single/:idx" component={BlogSingle} />
            <Route exact path="/help-center" component={HelpCenter} />
            <Route exact path="/how-it-works" component={HowItWorks} />
            <Route exact path="/privacy-terms" component={PrivacyTerms} />
            <Route exact path="/creators" component={Authors} />
            <Route exact path="/author/:idx" component={Author} />
