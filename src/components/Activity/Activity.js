                    ...
                    <div className="row items">
                        <div className="col-12 col-md-6 col-lg-8">
                            ...
                            <ul className="netstorm-tab nav nav-tabs" id="nav-tab">
                                <li>
                                    <Link className="active" id="nav-home-tab" data-toggle="pill" to="#nav-home">
                                        <h5 className="m-0">{this.state.data.tabTitle_1}</h5>
                                    </Link>
                                </li>
                                <li>
                                    <Link id="nav-profile-tab" data-toggle="pill" to="#nav-profile">
                                        <h5 className="m-0">{this.state.data.tabTitle_2}</h5>
                                    </Link>
                                </li>
                                <li>
                                    <Link id="nav-contact-tab" data-toggle="pill" to="#nav-contact">
                                            ...
                                            return (
                                                <li key={`ato_${idx}`} className="single-tab-list d-flex align-items-center">
                                                    ...
                                                    <div className="activity-content ml-4">
                                                        ...
                                                        <p className="m-0">Bid listed for <strong>{item.price}</strong> {item.time} <br />by <Link to="/author">{item.seller}</Link></p>
                                                    </div>
                                                </li>
                                            );
                                        })}
                                        ...
                                        <div className="widget-content">
                                            ...
                                            <div className="widget-content filter-widget-items mt-3">
                                                {this.state.filterData.map((item, idx) => {
                                                    return (
                                                        <Link key={`fd_${idx}`} to="#" className="badge tag">{item.title}</Link>
                                                    );
                                                })}
                                            </div>
                                        </div>
