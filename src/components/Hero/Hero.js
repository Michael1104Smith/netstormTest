                    ...
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-7">
                            ...
                            <div className="button-group">
                                <Link className="btn btn-bordered-white" to="/explore"><i className="icon-rocket mr-2" />{this.state.data.btn_1}</Link>
                                <Link className="btn btn-bordered-white" to="/create"><i className="icon-note mr-2" />{this.state.data.btn_2}</Link>
                            </div>
                        </div>
                    </div>
                </div>
