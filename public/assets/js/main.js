...
$( document ).ready(function() {
    ...
    (function ($) {
        ...
        $(document).on('click', '.react-share__ShareButton', function (event) {
    ...
    //         var Shuffle = window.Shuffle, Filter;
    //         if (document.querySelector('.explore-items-'+count)) {
    //             Filter  = new Shuffle(document.querySelector('.explore-items-'+count), {
